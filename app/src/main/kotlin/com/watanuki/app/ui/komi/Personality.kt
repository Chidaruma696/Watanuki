 ...
 * Palettes are Watanuki's own: one per Touhou Project character, light and dark.
 */
package com.watanuki.app.ui.komi
...
val LocalPersonality = staticCompositionLocalOf<MangaPersonality> {
	error("No Personality provided. Wrap content in WatanukiTheme { }.")
}
...
@Composable
fun WatanukiTheme(content: @Composable () -> Unit) {
